    ...
    <> 
      ...
      <group {...props} dispose={null}>
        <directionalLight
          ...
          position={[1439.94, 1587.04, 2922.46]}
          rotation={[0, 0.37, 0]}
        />
        <motion.group ref={phoneRef} name="iPhone 14 Pro" position={[-52.53, 15, 0]} onClick={animateNow} whileHover={{ scale: 1.2 }}>
          ...
          <group name="Camera" position={[53.08, 198.93, -18.9]} rotation={[0, 0, 0]} scale={1.16}>
            <mesh
              name="Cube 2"
          ...
          <group name="Body-Screen" position={[10.73, 26.77, 4.95]} rotation={[0, 0, 0]} scale={[1.02, 1.02, 1.04]}>
            <mesh
              name="Screen Border"
          ...
          <group name="LockScreen" position={[-1.12, 11.4, 42]} rotation={[0, 0, 0]} scale={[1.02, 1, 0.76]}>
            <mesh
              name="Right Side.png"
              geometry={nodes['Right Side.png'].geometry}
              material={materials['Right Side.png Material']}
              castShadow
              receiveShadow
              position={[79.75, 237.08, -25.11]}
              rotation={[0, 0.09, 0]}
              scale={[0.15, 0.15, 0.2]}
            />
            <group name="LockScreenScreen" position={[0, -0.5, -26.4]}>
              <mesh
                name="LockScreenFg"
                geometry={nodes.LockScreenFg.geometry}
                material={materials['LockScreenFg Material']}
                castShadow
                receiveShadow
                position={[0, -0.5, 2.67]}
                rotation={[0, 0, 0]}
              ...
              <mesh
                name="LockScreenBg"
                geometry={nodes.LockScreenBg.geometry}
                material={materials['LockScreenBg Material']}
                castShadow
                receiveShadow
                position={[0, 0.5, -2.67]}
                rotation={[0, 0, 0]}
